...
def translation(lang, tag):
    ...
    english = {
        ...
        'allvers': 'All versions',
        'main1': 'The easy way to share folders between computers, on LAN or Internet',
        'main2': 'Perfect for',
    ...
    spanish = {
        ...
        'allvers': 'Todas las versiones',
        'main1': 'La forma más sencilla de compartir carpetas entre ordenadores, en LAN o Internet',
        'main2': '¡Perfecto para',
